            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  >
                    Experience the future of healthcare with our AI-enabled
                    platform that combines multi-agent simulation, dynamic data
                    systems, and system thinking for precise minimal trauma
                    fracture diagnosis and treatment planning.
                  </p>
                </div>
