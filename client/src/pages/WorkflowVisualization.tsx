...
export default function WorkflowVisualization() {
  ...
  const recentDecisions = [
    ...
    },
    {
      time: "12:16 PM",
      agent: "Dr. Neural",
      decision: "Classify as minimal trauma fracture candidate",
      confidence: 87,
    },
    {
      time: "12:15 PM",
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
              <div>
                ...
                <p
                  ...
                  data-testid="text-workflow-patient"
                >
              ...
              <div>
                ...
                <p className="font-semibold">
                  {activeCase.estimatedCompletion}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center text-muted-foreground py-8">
                ...
                <p className="text-sm">
                  Real-time agent performance metrics and trends
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center text-muted-foreground py-8">
                ...
                <p className="text-sm">
                  Analysis of agent decision-making patterns and reliability
                </p>
              </div>
            </CardContent>
          </Card>
